  ...
  return {
    visitor: {
      Program(program, state) {
        ...
        const packages = (_state$opts = state.opts) !== null && _state$opts !== void 0 && _state$opts.packages ? normalize(state.opts.packages) : DEFAULT_PACKAGES_TO_PROCESS;
...
function normalize(packages) {
  return Object.keys(packages).reduce((all, pkg) => ({
    ...all,
...
export { DEFAULT_PACKAGES_TO_PROCESS, workerBabelPlugin as default };
